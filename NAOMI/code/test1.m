...
save_filename        = 'TPM_volume.mat';                                   % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
spike_opts.nt        = 15000;                                              % Set number of time step
...
save /home/adam/GITrepos/naomi_sim/20190729_LargeVolume_nomotion.mat -v7.3          % Saves all variables to a .mat file
