function h = showMatchedFeaturesMod(I1, I2, pts1, pts2, firstPlot, varargin)
...
%  an MSERRegions, or a cornerPoints object.
%
...
% $Revision: 1.1.6.7 $  $Date: 2012/11/15 14:56:30 $
...
plot(lineX(:), lineY(:), lineSpec{3},'linewidth',2); % line
...
parser.addParamValue('PlotOptions', {'yo','g+','r-'}, @checkPlotOptions);
